...
resultado_promedio  =  float(num1  +  num2  +  num3 + num4) /  4 #Falta cambiar el nombre de la variable, en este momento promedio es una Constante ya que esta en mayusculas.
...
class  Circulo:
    def __init__(self)-> None:
        self.radio = int(input(" Ingrese el radio: ")) #No es el alto, es el radio, esta mal el texto
    pass

    def  calcular_area ( self ):
        area=   3.14159 * (self.radio **  2) #Esta mal la formula del area, es pi(3.14159) por el radio al cuadrado
