...
nombre_propio =["María", "Pedro", "Juan", "José", "Gabriel", "nicolás", "Isabel", "Héctor", "Lorenzo", "Hugo", "María", "Pedro", "Juan", "José", "Gabriel"]
profesion = ["Camarero/a", "criminalista", "Botánico/a", "Agente de Ventas", "admistrativo", "Astrofísico", "carpintero", "Programador", "Agente de Ventas", "admistrativo", "Astrofísico", "carpintero"]
