...
precio = fs.ingresar_numero("Ingrese el precio $ ")
  
mi_producto = Producto(nombre, precio, cantidad)
cantidad_nueva = fs.ingresar_numero("Ingrese la cantidad a actualizar: ")
mi_producto.actualizar_cantidad(cantidad_nueva)
precio_nuevo = fs.ingresar_numero ("Ingrese el precio nuevo en $ ")
